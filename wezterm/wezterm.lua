...
local function font_with_fallback(name, params)
	--local names = { name, "Apple Color Emoji", "azuki_font", "AestheticIosevka", "Symbols Nerd Font Mono", "Symbols Nerd Font" }
	local names = { name, "Symbols Nerd Font Mono", "Symbols Nerd Font" }
